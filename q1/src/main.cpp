...
const char *BROKER_MQTT = "20.150.222.9";
...
const char *MQTT_PASSWORD = "Corpselain#4";
...
std::mt19937 gen(rd());
std::uniform_int_distribution<> distribPression(1000, 1013);
std::uniform_real_distribution<> distribAltitude(0, 500);
...
void updateSensorValues() {
  ...
  pression = distribPression(gen);

  altitude = distribAltitude(gen);
}
